...
3. Create a method 'displayResults' which displays the poll results. The method takes a string as an input (called 'type'), 
   which can be either 'string' or 'array'. If type is 'array', simply display the results array as it is, 
...
const poll = {
  ...
  displayResults() {
    // prettier-ignore
    const res = prompt("string or array")
    console.log(this);
    if (res == 'string') console.log('string ' + this.answers);
