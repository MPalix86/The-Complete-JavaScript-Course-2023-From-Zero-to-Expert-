...
btnScrollTo.addEventListener('click', function () {
  ...
  /**
   * possiamo inoltre ottenere info anche sul viewPort (ovvero la porzione di pagina attualemtne in uso)
   */
  console.log(
    'viewport',
   ...
   * ovvero il comando passato cosi, fuinziona solo se il viewport coincide con l'inizio della pagina
   *
   * la distanza B non ce l'ho direttamente ma ho la distanza del vieport dal top C (document.documentElement.clientHeight )
   *
  ...
  window.scrollTo(
    s1coords.left,
    s1coords.top + document.documentElement.clientHeight
  );
});
